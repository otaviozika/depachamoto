...
const checks={
  version:server.includes('const VERSION = "3.5.6";')&&pkg.version==="3.5.6",
  packageName:pkg.name==="despachefull",
  title:html.includes('<title>DespacheFull 3.5.6</title>'),
  ...
  serviceWorker:sw.includes('despachefull-v3.5.6-takeout-filter')&&sw.includes('/app-icon-192.png'),
...
console.log(JSON.stringify({result:"PASS",version:"3.5.6",brand:"DespacheFull",checks},null,2));
