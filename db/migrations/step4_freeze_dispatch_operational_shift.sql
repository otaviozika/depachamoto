...
BEFORE INSERT OR UPDATE OF operational_date, shift_code, departed_at ON public.dispatches
FOR EACH ROW EXECUTE FUNCTION public.freeze_dispatch_operational_shift();
