...
const checks = {
  version_350: server.includes('const VERSION = "3.6.1";') && pkg.version === '3.6.1' && html.includes('<title>DespacheFull 3.6.1</title>'),
  ...
  pwa_cache: sw.includes('despachefull-v3.6.1-')
};
