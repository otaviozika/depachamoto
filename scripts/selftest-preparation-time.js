...
const checks = {
  version_350: server.includes('const VERSION = "3.6.0";') && pkg.version === '3.6.0' && html.includes('<title>DespacheFull 3.6.0</title>'),
  ...
  pwa_cache: sw.includes('despachefull-v3.6.0-')
};
