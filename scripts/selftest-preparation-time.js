...
const checks = {
  version_350: server.includes('const VERSION = "3.5.0";') && pkg.version === '3.5.0' && html.includes('<title>DespacheFull 3.5.0</title>'),
  ...
  pwa_cache: sw.includes('despachefull-v3.5.0-preparation-time')
};
