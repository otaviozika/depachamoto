...
const checks={
  version:server.includes('const VERSION = "3.6.0";')&&pkg.version==="3.6.0",
  packageName:pkg.name==="despachefull",
  title:html.includes('<title>DespacheFull 3.6.0</title>'),
  ...
  serviceWorker:sw.includes('despachefull-v3.6.0-')&&sw.includes('/app-icon-192.png'),
...
console.log(JSON.stringify({result:"PASS",version:"3.6.0",brand:"DespacheFull",checks},null,2));
