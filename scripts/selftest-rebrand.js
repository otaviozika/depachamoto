...
const checks={
  version:server.includes('const VERSION = "2.8.0";')&&pkg.version==="2.8.0",
  packageName:pkg.name==="despachefull",
  title:html.includes('<title>DespacheFull 2.8.0</title>'),
  ...
  serviceWorker:sw.includes('despachefull-v2.8.0-checkin-required')&&sw.includes('/app-icon-192.png'),
...
console.log(JSON.stringify({result:"PASS",version:"2.8.0",brand:"DespacheFull",checks},null,2));
