...
const checks={
  version:server.includes('const VERSION = "2.7.0";')&&pkg.version==="2.7.0",
  packageName:pkg.name==="despachefull",
  title:html.includes('<title>DespacheFull 2.7.0</title>'),
  ...
  serviceWorker:sw.includes('despachefull-v2.7.0-operational-time')&&sw.includes('/app-icon-192.png'),
...
console.log(JSON.stringify({result:"PASS",version:"2.7.0",brand:"DespacheFull",checks},null,2));
