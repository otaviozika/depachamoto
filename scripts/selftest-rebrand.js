...
const checks={
  version:server.includes('const VERSION = "2.6.1";')&&pkg.version==="2.6.1",
  packageName:pkg.name==="despachefull",
  title:html.includes('<title>DespacheFull 2.6.1</title>'),
  ...
  serviceWorker:sw.includes('despachefull-v2.6.1-logo')&&sw.includes('/app-icon-192.png'),
...
console.log(JSON.stringify({result:"PASS",version:"2.6.1",brand:"DespacheFull",checks},null,2));
