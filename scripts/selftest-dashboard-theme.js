...
const checks={
  ...
  darkAdmin:html.includes('/* v3.6.0 — interface administrativa sóbria */')&&html.includes('#adminApp .admin-nav button.active:before')&&html.includes('#adminApp .dashboard-metric-card:after{display:none!important}'),
  ...
  footer:html.includes('class="dashboard-footer"')&&html.includes('Versão 3.6.0'),
  wallboardPreserved:html.includes('PEDIDOS EM PREPARO')&&html.includes('id="kdsPreparingList"'),
  cache:sw.includes('despachefull-v3.6.0-')
};
