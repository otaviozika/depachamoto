...
const checks = {
  version_290: /const VERSION = "3\.3\.0"/.test(server),
  ...
  courier_ui_manual_block_copy: /Saídas manuais são exclusivas do Admin/.test(ui),
  ...
  pwa_cache_290: /despachefull-v3\.3\.0-sober-ui/.test(sw),
