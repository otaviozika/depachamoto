...
app.get("/api/admin/wallboard", auth, adminOnly, asyncRoute(async (req, res) => {
  ...
  // KDS: apenas DELIVERY entra no Telão de despacho. TAKEOUT/DINE_IN continuam preservados no histórico/iFood,
  // mas nunca ocupam 'Pedidos em preparo' porque não possuem fluxo de motoboy.
  // Cancelados também deixam o quadro operacional.
